...
3/3 documents exist. 5 issue(s) found.

### Findings

- ⚠️ **WARNING**: Guide missing or incomplete section: Quick Start
  - Location: .project-manager/features/appointment-workflow/sessions/session-6.4.1-guide.md
...
- ⚠️ **WARNING**: Log document has no completed task entries
  - Location: .project-manager/features/appointment-workflow/sessions/session-6.4.1-log.md
