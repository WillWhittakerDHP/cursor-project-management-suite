...
- Generated at: **2026-03-04T18:06:57.328Z**
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| P1 | `TS2345-ts2345-arg-appointmentslots-timeslot` | 13 | 1 | 1 | 0 | 0 |
...
```
TS2345@168:57 Argument of type 'AppointmentSlots' is not assignable to parameter of type 'TimeSlot[]'.
```
