# Feature Start Audit: appointment-workflow
...
**Timestamp:** 2026-02-23T19:04:00.840Z
**Overall Status:** ❌ FAIL
...
1/3 documents exist. 2 issue(s) found.

### Findings

- ❌ **ERROR**: Guide document not found for feature appointment-workflow
  - Location: feature guide
  - Suggestion: Create guide document using appropriate planning command
- ⚠️ **WARNING**: Handover document not found for feature appointment-workflow
  - Location: feature handoff
