...
async function checkTransformerDocs(): Promise<string> {
  ...
  sections.push('- `client-vue/src/api/transformers/`\n');
  ...
  sections.push('- `client-vue/src/api/transformers/adminTransformer.ts`');
  sections.push('- `client-vue/src/api/transformers/globalTransformer.ts`');
...
async function checkPatternDocs(): Promise<string> {
  ...
  sections.push('- Composables: `client-vue/src/composables/`');
...
async function checkMigrationDocs(): Promise<string> {
  ...
  sections.push('- `.cursor/project-manager/features/vue-migration/sessions/session-[X.Y]-guide.md` - Session structure and workflow');
