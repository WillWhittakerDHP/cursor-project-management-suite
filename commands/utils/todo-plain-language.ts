...
function inferPlanningDocPath(
  ...
  switch (tier) {
    case 'feature':
      return `.cursor/project-manager/features/${feature}/feature-${feature}-guide.md`;
    case 'phase':
      return `.cursor/project-manager/features/${feature}/phases/phase-${context?.currentPhase || 1}-guide.md`;
    case 'session':
      return `.cursor/project-manager/features/${feature}/phases/phase-${context?.currentPhase || 1}-guide.md`;
    case 'task':
      return `.cursor/project-manager/features/${feature}/phases/phase-${context?.currentPhase || 1}-guide.md`;
