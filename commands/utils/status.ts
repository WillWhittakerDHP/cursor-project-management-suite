...
export async function status(): Promise<string> {
  ...
  output.push('- Handoff: `.cursor/project-manager/features/vue-migration/feature-vue-migration-handoff.md`');
  output.push('- Session Log: `.cursor/project-manager/features/vue-migration/sessions/session-[X.Y]-log.md`');
  output.push('- Session Guide: `.cursor/project-manager/features/vue-migration/sessions/session-[X.Y]-guide.md`');
