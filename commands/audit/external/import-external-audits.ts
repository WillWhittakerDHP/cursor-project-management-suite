    ...
    sources: [
      {
        ...
        paths: [
          `${FRONTEND_ROOT}/.audit-reports/typecheck/typecheck-audit.json`,
          `${FRONTEND_ROOT}/.audit-reports/typecheck/typecheck-audit.md`,
          `${FRONTEND_ROOT}/.audit-reports/typecheck/typecheck-audit-summary.md`,
        ],
      },
      {
        ...
        paths: [
          `${FRONTEND_ROOT}/.audit-reports/composables-logic-audit.json`,
          `${FRONTEND_ROOT}/.audit-reports/composables-logic-audit.md`,
          `${FRONTEND_ROOT}/.audit-reports/composables-logic-audit-summary.md`,
        ],
      },
      {
        ...
        paths: [
          `${FRONTEND_ROOT}/.audit-reports/component-logic-audit.json`,
          `${FRONTEND_ROOT}/.audit-reports/component-logic-audit.md`,
          `${FRONTEND_ROOT}/.audit-reports/component-logic-audit-summary.md`,
        ],
      },
    ],
  };
