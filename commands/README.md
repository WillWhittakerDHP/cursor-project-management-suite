...
- `/lint [target]` - Run linting (vue/server/all) - React target removed after migration
- `/type-check` - Run type checking for Vue app
- `/test [target] [--watch]` - Run tests (vue/server/all) - React target removed after migration
...
**Feature Level:**
```
/plan-feature vue-migration "Migrate React app to Vue.js"
