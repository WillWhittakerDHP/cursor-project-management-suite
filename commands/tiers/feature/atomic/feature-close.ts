...
export async function featureClose(featureName: string): Promise<string> {
  ...
  const featureGuidePath = `.cursor/project-manager/features/${featureName}/feature-${featureName}-guide.md`;
  const featureLogPath = `.cursor/project-manager/features/${featureName}/feature-${featureName}-log.md`;
  const featureHandoffPath = `.cursor/project-manager/features/${featureName}/feature-${featureName}-handoff.md`;
