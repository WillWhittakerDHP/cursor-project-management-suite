...
#### Quality Checks
- `/lint [target]` - Run linting (vue/server/all, default: all) - React target removed after migration
- `/type-check` - Run type checking for Vue app
- `/test [target] [--watch]` - Run tests (vue/server/all, default: vue) - React target removed after migration
