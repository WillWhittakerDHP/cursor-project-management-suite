...
export async function workflowCleanupReadmes(params: WorkflowCleanupParams): Promise<string> {
  try {
    ...
    switch (params.tier) {
      case 'feature':
        // Feature directory: .cursor/project-manager/features/{feature}
        directory = `.cursor/project-manager/features/${featureName}`;
        break;
      case 'phase':
        // Phase directory: .cursor/project-manager/features/{feature}/phases
        directory = `.cursor/project-manager/features/${featureName}/phases`;
        break;
      case 'session':
        // Session directory: .cursor/project-manager/features/{feature}/sessions
        directory = `.cursor/project-manager/features/${featureName}/sessions`;
        break;
    }
